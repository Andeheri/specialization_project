...
The thesis is structured as follows: \cref{ch:theory} provides the theoretical background necessary for understanding the subsequent chapters, including anatomy, modelling, and control theory. \cref{ch:modelling} details the modelling of the finger dynamics using the Euler-Lagrange equations. Further the chapter covers the dynamics of the brushed DC motors, and estimates of the model parameters. The chapter also includes  \cref{ch:controller_design} presents the design, analysis and simulation-based validation of a current controller, torque and force controller, and position control for controlling the position of the fingertip. \cref{ch:discussion} discusses the results and findings of the thesis, and provides an outlook on future work, and finally, \cref{ch:conclusion} concludes the thesis.
